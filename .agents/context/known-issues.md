...
- 公开 v0.7.0 中 Codex 是默认关闭的实验能力，边界为单账号、浏览器登录、macOS Apple Silicon。v0.8.0-linux-beta.1 源码新增 Ubuntu x64 编译/运行合同，但上述 Linux live 证据尚未建立。上游账号权限、动态模型目录和 Responses 协议可能变化。
